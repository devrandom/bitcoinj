...
public class WalletTest extends TestWithWallet {
    ...
    private void createMarriedWallet(int threshold, int numKeys, boolean addSigners) throws BlockStoreException {
        ...
        for (int i = 0; i < numKeys - 1; i++) {
            ...
            DeterministicKey partnerKey = DeterministicKey.deserializeB58(params, watchingKey.serializePubB58(params), watchingKey.getParent().getPath());
    ...
    public void watchingWallet() throws Exception {
        ...
        watchKey = DeterministicKey.deserializeB58(params, watchKey.serializePubB58(params), watchKey.getParent().getPath());
    ...
    public void watchingWalletWithCreationTime() throws Exception {
        ...
        watchKey = DeterministicKey.deserializeB58(params, serialized, watchKey.getParent().getPath());
    ...
    public void keyRotationHD2() throws Exception {
        ...
        assertEquals("n3GcCW4spuUQY4sEnDzNbY4cQLVy2Nf8hP", usedKey.toAddress(params).toString());
    ...
    public void watchingMarriedWallet() throws Exception {
        DeterministicKey watchKey = wallet.getWatchingKey();
        String serialized = watchKey.serializePubB58(params);
        watchKey = DeterministicKey.deserializeB58(params, null, serialized);
        Wallet wallet = Wallet.fromWatchingKey(params, watchKey);
        blockStore = new MemoryBlockStore(params);
        chain = new BlockChain(params, wallet, blockStore);

        final DeterministicKeyChain keyChain = new DeterministicKeyChain(new SecureRandom());
        DeterministicKey partnerKey = DeterministicKey.deserializeB58(params, null, keyChain.getWatchingKey().serializePubB58(params));

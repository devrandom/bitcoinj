...
//            ExtendedHierarchicKey ekpub_1_IN_4bil = HDKeyDerivation.deriveChildKey(ekpub_1_IN, 4294967295L);
    ...
    public void serializeToTextAndBytes() {
...

        {
            ...
            assertEquals(DeterministicKey.deserializeB58(params, null, priv58), key1);
            assertEquals(DeterministicKey.deserializeB58(priv58, params), key1);
            assertEquals(DeterministicKey.deserializeB58(params, null, pub58).getPubKeyPoint(), key1.getPubKeyPoint());
            assertEquals(DeterministicKey.deserializeB58(pub58, params).getPubKeyPoint(), key1.getPubKeyPoint());
            assertEquals(DeterministicKey.deserialize(params, priv, (DeterministicKey)null), key1);
            assertEquals(DeterministicKey.deserialize(params, priv), key1);
            assertEquals(DeterministicKey.deserialize(params, pub, (DeterministicKey)null).getPubKeyPoint(), key1.getPubKeyPoint());
        ...
        }
        {
            ...
            assertEquals(DeterministicKey.deserializeB58(params, key1, priv58), key2);
            assertEquals(DeterministicKey.deserializeB58(params, key1, pub58).getPubKeyPoint(), key2.getPubKeyPoint());
    ...
    public void parentlessDeserialization() {
        ...
        assertEquals(DeterministicKey.deserialize(params, key4.serializePrivate(params), (DeterministicKey)null).getPath().size(), 1);
